...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="{{url('Backend/plugins/images/favicon.png')}}"
    />
    <!-- Custom CSS -->
    <link
      href="{{url('Backend/plugins/bower_components/chartist/dist/chartist.min.css')}}"
      rel="stylesheet"
    />
    <link
      rel="stylesheet"
      href="{{url('Backend/plugins/bower_components/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css')}}"
    />
    <!-- Custom CSS -->
  ...
  <body>
            ...
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item">
                ...
                >
                  ...
                  <span class="hide-menu">Pssengers Info</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a
                ...
                >
                  ...
                  <span class="hide-menu">Bus Info</span>
                </a>
              </li>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-12">
              <div class="white-box analytics-info">
                <h4 class="box-title">Bus Info</h4>
            ...
            <div class="col-lg-4 col-md-12">
              <div class="white-box analytics-info">
                <h4 class="box-title">Passengers Info</h4>
                <ul class="list-inline two-part d-flex align-items-center mb-0">
    ...
    <script src="{{url('Bckend/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
    <!--Wave Effects -->
    ...
    <script src="j{{url('Backend/s/pages/dashboards/dashboard1.js')}}"></script>
  </body>
</html>
